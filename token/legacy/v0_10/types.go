...
type (
	...
	Token struct {
		...
		Symbol              string         `json:"symbol" v2:"symbol"`                               // e.g. "fax"
		OriginalSymbol      string         `json:"original_symbol" v2:"original_symbol"`             // e.g. "fax"
		WholeName           string         `json:"whole_name" v2:"whole_name"`                       // e.g. "fax"
