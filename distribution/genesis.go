...
func InitGenesis(ctx sdk.Context, keeper Keeper, supplyKeeper types.SupplyKeeper, data types.GenesisState) {
	keeper.SetCommunityAddress(ctx, data.CommunityAddress)
...
func ExportGenesis(ctx sdk.Context, keeper Keeper) types.GenesisState {
	...
	communityAddress := keeper.GetCommunityAddress(ctx)
	...
	return types.NewGenesisState(params, feePool, dwi, pp, acc, communityAddress)
}
